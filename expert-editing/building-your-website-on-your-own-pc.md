...
If you are using [Code Hooks](code-hooks.md) and any of your themes include a `requirements.txt` file for extra Python libraries, install the libraries defined in that file as well:
